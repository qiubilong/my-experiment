...
public class K个一组翻转链表 {
    ...
    public static void main(String[] args) {
        ...
        ListNode head = MyLists.buildList(Lists.newArrayList(nums));
        MyLists.printList(head);
        ...
        System.out.println("==========reverseList============");
        MyLists.printList(reverseListKV2(MyLists.buildList(Lists.newArrayList(1,2,3,4)), 2));
        System.out.println("==========reverseList============");
        MyLists.printList(reverseListKV2(MyLists.buildList(Lists.newArrayList(1, 2, 3, 4, 5)), 3));
    }
