...
class EPollArrayWrapper {
    ...
    private final AllocatedNativeObject pollArray;                     //对应 Epoll的IO事件就绪列表readyList
    ...
    EPollArrayWrapper() throws IOException {
        ...
        epfd = epollCreate();                                          //创建epoll监控器 -- epoll_create
...
/**
    ...
    int poll(long timeout) throws IOException {
        updateRegistrations();                                                           // 注册监听IO事件  -- epoll_ctl
        updated = epollWait(pollArrayAddress, NUM_EPOLLEVENTS, timeout, epfd);           //等待IO事件发生   -- epoll_wait    -->
